...
class UserProfile(models.Model):
    ...
    default_street_address1 = models.CharField(max_length=80, default='', blank=True)
    default_street_address2 = models.CharField(max_length=80, default='', blank=True)
    ...
    default_country = CountryField(blank_label='Country', default='', blank=True)
